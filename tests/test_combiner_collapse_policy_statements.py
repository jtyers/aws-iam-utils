...
def test_collapse_policy_action_lists():
    p = create_policy(
        ...
        statement(
            actions=["s3:GetObject", "s3:GetObjectAcl", "s3:ListBucket"], resource="*"
        ),
    )
...
def test_collapse_policy_action_lists_in_multiple_policies():
    pp = [
        ...
        create_policy(
            statement(
                actions=["s3:PutObjectVersion", "s3:PutObjectLock"], resource="*"
            ),
        ),
        create_policy(
            statement(actions=["s3:PutLegalHold", "s3:PutObjectAcl"], resource="*"),
            statement(
                actions=["s3:ListAllMyBuckets", "s3:GetBucketTagging"], resource="*"
            ),
        ),
    ]
...
def test_collapse_policy_action_lists_in_multiple_policies_with_duplicates():
    pp = [
        ...
        create_policy(
            statement(actions=["s3:PutLegalHold", "s3:PutObjectAcl"], resource="*"),
            statement(
                actions=["s3:ListAllMyBuckets", "s3:GetBucketTagging", "s3:PutObject"],
                resource="*",
            ),
        ),
    ]
