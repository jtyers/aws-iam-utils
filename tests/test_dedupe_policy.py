...
def test_dedupe_policy_actions():
    p = create_policy(
        statement(
            actions=["s3:listbucket", "s3:createbucket", "s3:createbucket"],
            resource=["foo"],
            principal={"AWS": ["bar"]},
        ),
    )
